...
##############
train_path_data = "../data/seg/2d_slices/train/Joint/" # Change folder to Prostate, Rectum or Bladder based on the intended ROI
# E.g.
#train_path_data = "../data/seg/2d_slices/train/Prostate/"
#train_path_data = "../data/seg/2d_slices/train/Rectum/"
#train_path_data = "../data/seg/2d_slices/train/Bladder/"
