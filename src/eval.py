import glob
import torch 
from model.gm_vqvae import GM_VQVAE, Encoder, ResBlock, Quantize, Decoder
import numpy as np 
import pandas as pd 
from scipy import ndimage
from utils.dataloader import standard_resize2d
from utils.evaluation_metrics import calculate_surface_dsc, calculate_hausoff_dist
...
## Path data list
path_data = "../data/seg/3d_masks/test/Joint/"
path_data_prostate = "../data/seg/3d_masks/test/Prostate/"
path_data_rectum = "../data/seg/3d_masks/test/Rectum/"
path_data_bladder = "../data/seg/3d_masks/Bladder/"
